class ApplicationController < ActionController::Base
  ...
  def calendar_occurrences_for_range(range_start, range_end, draft: nil, course_id: nil)
    ...
    result = (event_occurrences + course_occurrences + work_shift_occurrences + course_items_scope.to_a).sort_by(&:starts_at)
